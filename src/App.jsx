      ...
      <section className="relative isolate bg-gradient-to-br from-sky-950 via-blue-800 to-cyan-700 text-white">
        ...
        <div className="mx-auto grid min-h-[92svh] max-w-7xl items-center gap-10 px-5 py-10 sm:px-8 lg:grid-cols-[1.06fr_0.94fr] lg:px-10">
          ...
          <div className="relative mx-auto w-full max-w-xl pb-6 lg:pb-0">
            <div className="rounded-[2rem] border border-white/20 bg-white/10 p-5 shadow-2xl shadow-sky-950/30 backdrop-blur-md">
              <div className="overflow-hidden rounded-[1.5rem] bg-white text-slate-900 shadow-xl">
                <div className="relative aspect-[3/2] bg-gradient-to-br from-sky-900 via-blue-800 to-cyan-700">
                  <img
                    src={vhuImages.faculty}
                    alt="Sinh viên Khoa Kinh tế - Quản trị VHU"
                    className="h-full w-full object-cover object-center"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/62 via-slate-950/10 to-transparent" />
                  <div className="absolute right-4 top-4 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-2xl">
                    <img
                      src={vhuImages.activity}
                      alt="Hoạt động tuyển sinh VHU"
                      className="h-28 w-36 object-cover object-top sm:h-32 sm:w-44"
                    />
                  </div>
                  <div className="absolute bottom-28 left-4 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-2xl sm:left-6">
                    <img
                      src={vhuImages.scholarship}
                      alt="Sinh viên VHU nhận học bổng"
                      className="h-24 w-32 object-cover object-top sm:h-28 sm:w-40"
                    />
                  </div>
                  <div className="absolute bottom-5 left-5 right-5 rounded-2xl border border-white/20 bg-white/95 p-4 shadow-xl backdrop-blur">
                    <p className="text-sm font-bold text-sky-700">Khoa Kinh tế - Quản trị</p>
                    <p className="mt-1 text-2xl font-black text-slate-950">Learning by doing</p>
                  </div>
                </div>
      ...
      <section className="bg-white px-5 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="overflow-hidden rounded-[2rem] bg-slate-100 shadow-2xl shadow-slate-200">
              <img
                src={vhuImages.business}
                alt="Ngành Quản trị Kinh doanh tại VHU"
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-[0.78fr_1.22fr]">
            <div className="relative overflow-hidden rounded-[2rem] bg-slate-900 shadow-2xl shadow-slate-200">
              <img
                src={vhuImages.career}
                alt="Sinh viên VHU trong định hướng cơ hội nghề nghiệp"
                className="aspect-[3/2] h-auto w-full object-cover object-center"
              />
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="mt-2 text-2xl font-black text-white">
                  Học để sẵn sàng bước vào môi trường doanh nghiệp.
                </p>
              </div>
            </div>
